    ...
    <div className="min-h-screen bg-indigo-50 flex flex-col items-center p-6">
      ...
      <div className="w-full max-w-lg bg-white rounded-3xl shadow-xl p-6">
        ...
        <div
          ...
          onDrop={handleDrop}
          className={`w-full aspect-square rounded-2xl mb-6 flex items-center justify-center overflow-hidden border-4 relative group transition-all duration-200
            ${loading
              ? 'bg-slate-100 border-indigo-100'
              : isDragging
                ? 'bg-green-50 border-green-400 scale-105 shadow-lg cursor-pointer'
                : !generatedImage
                  ? 'bg-slate-100 border-indigo-100 cursor-pointer hover:bg-slate-50 hover:border-indigo-200'
                  : 'bg-slate-100 border-indigo-100'
            }
          `}
        >
          ...
          {!loading && generatedImage && (
            <img src={generatedImage} alt="Generated Buddy" className="w-full h-full object-contain" />
          )}
